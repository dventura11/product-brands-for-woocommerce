         ...
         <div class="project-content">
            <aside class="share-buttons clearfix">
               ...
               <div class="holder clearfix">
                  <a target="_blank" class="btn-twitter" href="https://twitter.com/home?status=<?= 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] ?>"></a>
                  <a target="_blank" class="btn-facebook" href="https://www.facebook.com/share.php?u=<?= 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] ?>"></a>
                  <a target="_blank" class="btn-gplus" href="https://plus.google.com/share?url=<?= 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] ?>"></a>
